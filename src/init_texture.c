...
int init_value_texture_no(game_s *game, size_t y)
{
    ...
    i += 2;
    game->text_no = ft_strjoin(NULL, game->map[y] + i);
    if (!game->text_no)
        return (-1);
    return (0);
}
...
int init_value_texture_so(game_s *game, size_t y)
{
    ...
    i += 2;
    game->text_so = ft_strjoin(NULL, game->map[y] + i);
    if (!game->text_so)
        return (-1);
    return (0);
}
...
int init_value_texture_we(game_s *game, size_t y)
{
    ...
    i += 2;
    game->text_we = ft_strjoin(NULL, game->map[y] + i);
    if (!game->text_we)
        return (-1);
    return (0);
}
...
int init_value_texture_ea(game_s *game, size_t y)
{
    ...
    i += 2;
    game->text_ea = ft_strjoin(NULL, game->map[y] + i);
    if (!game->text_ea)
        return (-1);
    return (0);
}
...
int init_value_texture_f(game_s *game, size_t y)
{
    ...
    i += 1;
    game->text_f = ft_strjoin(NULL, game->map[y] + i);
    if (!game->text_f)
        return (-1);
    return (0);
}
...
int init_value_texture_c(game_s *game, size_t y)
{
    ...
    i += 1;
    game->text_c = ft_strjoin(NULL, game->map[y] + i);
    if (!game->text_c)
        return (-1);
    return (0);
}